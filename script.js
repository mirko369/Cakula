...
const drinks = {
  ...
  desertWine: {
    ...
    price: ["4,00 Є / 30,00 kn", "4,00 Є / 30,00 kn", "4,00 Є / 30,00 kn"],
  },
  domesticAlcohol: {
    name: [
      "Amaro",
  ...
  beverages: {
    name: [
      ...
      "Limunada / lemonade",
      "Narančada / orange",
      "Voda negazirana plastika to go / Natural water plastic to go",
      "Voda negazirana plastika to go / Natural water plastic to go",
      "Mineralna voda plastika to go / Mineral water plastic to go",
      "Mineralna voda plastika to go / Mineral water plastic to go",
      "Coca Cola plastika to go / Coca Cola plastic to go",
      "Sprite plastika to go / Sprite plastic to go",
      "Fanta plastika to go / Fanta plastic to go",
    ],
    measure: [
      "0,275 l",
      "0,25 l",
  ...
  cider: {
    name: ["Somersby"],
    measure: ["0,33 l"],
    price: ["5,50 Є / 41,00 kn"],
  },
  energyDrinks: {
    name: ["Red Bull"],
    measure: ["0,25 l"],
    price: ["5,60 Є / 42,00 kn"],
  },
  warmDrinks: {
    name: [
      "Kava / Espresso",
  ...
  sweets: {
    ...
    price: ["2,00 Є / 15,00 kn", "2,50 Є / 19,00 kn", "0,50 Є / 4,00 kn"],
  },
};
